...
urlpatterns = [
    ...
    path('threads/<str:topic_title>', views.ThreadListByTopic.as_view(renderer_classes=[JSONRenderer]), name="thread-list-by-topic"),
    ...
    path('posts/<int:thread_title_id>', views.PostListByThread.as_view(renderer_classes=[JSONRenderer]), name="post-list-by-thread"),
